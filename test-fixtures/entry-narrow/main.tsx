...
import '../../src/entry-react/style.css'
...
function measure(width: number): { width: number; failures: string[]; metrics: Record<string, unknown> } {
  ...
  const snlName = fixture.querySelector<HTMLElement>('[data-scenario="snl-id"] [data-name]')
  check(snlName?.dataset.name === longId, 'snl-id: preserves identifier')
